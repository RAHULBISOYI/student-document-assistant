...
$sql="Select * from user where u_name ='$username' AND  c_pass='$password' ";
    ...
    $result = mysqli_query($conn, $sql);//sends the query to the database.

    $num = mysqli_num_rows($result);//this isused for knowing how many record will be fetch;
        if ($num==1) {//it will be check that the u_name and the U_pass is match or not
            $login = true;
            session_start();
            $_SESSION['loggedin']=true;
            $_SESSION['u_name']=$username;
            header("location:home.php");//basicaly it is used for when we clic that particular button than it go tothe destination which you will be give;
        } else {
...
<div class="container">
    <div class="signup-container">
        ...
        <form action="/rahul/login_System/login.php" method="POST">
   ...
   <div class="mb-3">
    ...
    <p class="mt-3 text-center">I don't have any account.! <a href="/RAHUL/login_System/sign.php">Sign Up</a></p>
