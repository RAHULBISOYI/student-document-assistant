...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['save'])) {
    ...
    $stmt = $conn->prepare("INSERT INTO resumes (u_name, job_title, education, skills, contact, introduction, career_progression, certifications, phone, address, website, email, github, linkedin, image_path) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
